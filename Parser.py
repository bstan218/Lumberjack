...
class ParsedFile:
    def __init__(self, filepath, template=False, coreidentity=None, rotamer_coords=None, is_realligands_files=True):
        ...
        self.is_realligands_files = is_realligands_files
